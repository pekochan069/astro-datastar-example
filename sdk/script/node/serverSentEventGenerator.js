...
exports.ServerSentEventGenerator = void 0;
const types_js_1 = require("../types.js");
const abstractServerSentEventGenerator_js_1 = require("../abstractServerSentEventGenerator.js");
 ...
 */
class ServerSentEventGenerator extends abstractServerSentEventGenerator_js_1.ServerSentEventGenerator {
    constructor(req, res) {
        super();
        ...
        this.req = req;
        this.res = res;
        this.res.writeHead(200, types_js_1.sseHeaders);
        this.req.on("close", () => {
            this.res.end();
        });
    }
    ...
    static async readSignals(request) {
        if (request.method === "GET") {
            const url = new URL(`http://${node_process_1.default.env.HOST ?? "localhost"}${request.url}`);
...
exports.ServerSentEventGenerator = ServerSentEventGenerator;
